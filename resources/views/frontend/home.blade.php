                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="wrapper-card-content">
                                <button class="btn-explore"><a href="{{ route('coffee-detail') }}">Explore
                                        More</a></button>
                                <h1>.02</h1>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="wrapper-card-content">
                                <button class="btn-explore"><a href="{{ route('cashewnuts-detail') }}">Explore
                                        More</a></button>
                                <h1>.04</h1>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <div class="wrapper-card-content">
                                <button class="btn-explore"><a href="{{ route('potatocassava-detail') }}">Explore
                                        More</a></button>
                                <h1>.05</h1>
                            </div>
